"""Validate agent-authored Demo 3 batches and print a distribution report.

    .venv/bin/python -m scripts.g1_demo3_report --enforce-distribution
...
def main() -> None:
    ...
    if not paths:
        raise SystemExit(
            f"No authored JSON files found for {args.demo} under {args.root}"
        )
