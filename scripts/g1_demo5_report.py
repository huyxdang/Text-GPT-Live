"""Validate agent-authored Demo 5 bank batches and print a distribution report.

    .venv/bin/python -m scripts.g1_demo5_report --enforce-distribution
...
def main() -> None:
    ...
    report = validate_demo5_batches(load_authored_batches(paths), enforce_distribution=args.enforce_distribution)
